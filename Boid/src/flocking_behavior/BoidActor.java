...
public class BoidActor implements Actor {
	...
	public void update(double time) {
		...
		if (colorC[0] < colorT[0])
			colorC[0]++;
		else if (colorC[0] > colorT[0])
			colorC[0]--;
		if (colorC[1] < colorT[1])
			colorC[1]++;
		else if (colorC[1] > colorT[1])
			colorC[1]--;
		if (colorC[2] < colorT[2])
			colorC[2]++;
		else if (colorC[2] > colorT[2])
			colorC[2]--;
	}
	...
	public void setColor(int[] c) {
		colorT[0] = (int) (c[0] * brightness);
		if (colorT[0] >= 256)
			colorT[0] = 255;
		colorT[1] = (int) (c[1] * brightness);
		if (colorT[1] >= 256)
			colorT[1] = 255;
		colorT[2] = (int) (c[2] * brightness);
		if (colorT[2] >= 256)
			colorT[2] = 255;
	}
